...
import { setPage, showAllProduct } from "../../store/reducers/homeReducer";
...
class Home extends React.PureComponent {
  ...
  render() {
    const { items, currentPage, totalPage, loading } = this.props.home;
    return (
...
const mapDispatchToProps = (dispatch) => ({
  products: () => dispatch(showAllProduct()),
  page: (count) => dispatch(setPage(count)),
  dispatch,
});
